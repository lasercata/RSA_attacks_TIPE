...
\begin{document}
    ...
    \thetitle{RSA attacks}{Code listings}
    
    \tableofcontents
    \newpage

    \begin{indt}{\section{Structure du code}}
        % \includegraphics[scale=.3]{Code_struct.png}
    ...
    \begin{indt}{\section{Code}}
        \begin{indt}{\subsection{\texttt{main.py}}}
            \lstinputlisting[language=Python, xleftmargin=0pt]{../../main.py}
        \end{indt}
        
        \vspace{12pt}
        
        \begin{indt}{\subsection{\texttt{arithmetic.py}}}
            \lstinputlisting[language=Python, xleftmargin=0pt]{../../modules/arithmetic.py}
        \end{indt}
        
        \vspace{12pt}
        
        \begin{indt}{\subsection{\texttt{base.py}}}
            \lstinputlisting[language=Python, xleftmargin=0pt]{../../modules/base.py}
        \end{indt}
        
        \vspace{12pt}
        
        \begin{indt}{\subsection{\texttt{RSA.py}}}
            \lstinputlisting[language=Python, xleftmargin=0pt]{../../modules/RSA.py}
        \end{indt}
        
        \vspace{12pt}
        
        \begin{indt}{\subsection{\texttt{RSA\_attacks.py}}}
            \lstinputlisting[language=Python, xleftmargin=0pt]{../../modules/RSA_attacks.py}
        \end{indt}
        
        \vspace{12pt}
        
        \begin{indt}{\subsection{\texttt{test\_attacks.py}}}
            \lstinputlisting[language=Python, xleftmargin=0pt]{../../modules/test_attacks.py}
        \end{indt}
        
        \vspace{12pt}
        
        \begin{indt}{\subsection{\texttt{tests.py}}}
            \lstinputlisting[language=Python, xleftmargin=0pt]{../../modules/tests.py}
        \end{indt}
    \end{indt}
